...
export const metadata = {
  title: 'Privacy Policy | Princess Beauty Studio Huntingdon',
  description: 'Privacy Policy for Princess Beauty Studio HIFU Treatments, Huntingdon',
}
        ...
        <div className="prose prose-neutral max-w-none space-y-8">
          <section>
            ...
            <p className="text-neutral-700 leading-relaxed">
              Princess Beauty Studio ("we", "our", or "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website hifuhuntingdon.co.uk and use our services.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-neutral-700 leading-relaxed mb-4">
              Our website may use tracking technologies to:
            </p>
            <ul className="list-disc pl-6 space-y-2 text-neutral-700">
            ...
            <p className="text-neutral-700 leading-relaxed mt-4">
              These technologies may collect information including your IP address, browser type, pages visited, time spent on pages, and actions taken. You can opt out of personalized advertising by adjusting your browser privacy settings.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-neutral-700">
              ...
              <li><strong>Marketing Partners:</strong> For advertising purposes</li>
          ...
          <section>
            ...
            <div className="bg-white rounded-xl p-6 border border-neutral-200">
              <p className="font-semibold mb-2">Princess Beauty Studio</p>
              <p className="text-neutral-700">16 Ash Tree Avenue</p>
              <p className="text-neutral-700">Godmanchester</p>
              <p className="text-neutral-700">Cambridgeshire PE29 2FH</p>
              <p className="text-neutral-700 mt-3">
                <strong>Phone:</strong> <a href="tel:07743080038" className="text-primary-600 hover:text-primary-700">07743 080038</a>
              </p>
            </div>
          </section>
