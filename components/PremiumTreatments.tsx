...
export default function PremiumTreatments({ onBookingClick }: PremiumTreatmentsProps) {
  const treatments = [
    ...
    },
    {
      ...
      description: 'Complete non-surgical facelift with advanced TA2 7D System',
      features: ['TA2 7D — 30% more effective', 'Full face & neck treatment', 'Eye area lifting', '90 minute session'],
      price: '£395',
