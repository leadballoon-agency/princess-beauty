...
export default function ProcessSection({ onBookingClick }: ProcessSectionProps) {
  const steps = [
    ...
    },
    {
      ...
      description: 'Professional HIFU session targeting your areas of concern',
      icon: '🔬',
      duration: '60-90 mins'
    },
    {
      ...
      description: 'Walk out with visible lifting - no downtime needed',
      icon: '✨',
      duration: 'Same day'
    },
    {
      ...
      description: 'Collagen builds for 2-3 months, results last 1-2 years',
      icon: '📈',
      duration: '2-3 months'
    }
  ]
            ...
            <div>
              <div className="bg-gradient-to-r from-primary-100 to-primary-50 rounded-xl p-4 mb-4">
                <div className="flex items-center mb-2">
                  ...
                  <h4 className="font-bold text-primary-800">Zero Downtime Treatment</h4>
                </div>
                <p className="text-sm leading-relaxed text-primary-700">Unlike surgical facelifts, HIFU requires no recovery time. You can return to your normal activities immediately after treatment.</p>
              </div>
              ...
              <ul className="space-y-2 sm:space-y-3">
                <li className="flex items-start">
                  ...
                  <span className="text-sm sm:text-base leading-relaxed text-neutral-700">Immediately: Some visible lifting, possible mild redness</span>
                </li>
                <li className="flex items-start">
                  <span className="text-primary-500 mr-2 sm:mr-3 mt-0.5 sm:mt-1">✓</span>
                ...
                <li className="flex items-start">
                  <span className="text-primary-500 mr-2 sm:mr-3 mt-0.5 sm:mt-1">✓</span>
                  <span className="text-sm sm:text-base leading-relaxed text-neutral-700">Month 1-2: Noticeable tightening and lifting effects</span>
                </li>
                <li className="flex items-start">
                  <span className="text-primary-500 mr-2 sm:mr-3 mt-0.5 sm:mt-1">✓</span>
                  <span className="text-sm sm:text-base leading-relaxed text-neutral-700">Month 3+: Peak results achieved, lasting 1-2 years</span>
                </li>
              </ul>
            </div>
